package com.microblog.points.service.configuration.quartz;
...
public class SchedulerHandle {
    ...
    */
    public boolean addJod(QuartzJob job) throws ClassNotFoundException, SchedulerException {
        ...
        //hello-group.common.microblog.points.dao.model.QuartzJob
        //hello-group.common.microblog.points.service.job.HelloJob
