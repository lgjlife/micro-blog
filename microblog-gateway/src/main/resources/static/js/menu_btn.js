var menu_manager={
    "url":{
        "apiDocUrl": "http://localhost:7004/zuul/swagger-ui.html",
    },
    /**
     *去除 --选项中的--
     * @param str
    ...
    "handleMenuBodySysApidoc":function () {
        $("#home-right-body-sys-apidoc").show();
    },
    /**
     * 注册中心
     */
    "handleMenuBodySysRegisterCenter":function () {
        $("#home-right-body-sys-registercenter").show();
    },
    /**
     * zipkin 监控
     */
    "handleMenuBodySysZipkin":function () {
        ...
        $("#home-right-body-sys-zipkin").show();
    },
    ...
    "handleMenuBodySysDruid":function () {
        console.log("zipkin监控....")
        $("#home-right-body-sys-druid").show();
    },
    /**
     * 任务监控
     * */
    "handleMenuBodySysScheduler":function () {
        console.log("任务监控....")
        $("#home-right-body-sys-scheduler").show();
    },
    ...
    "titleAddList":function (text) {
        ...
        var val;
        var title_text;
       $("#home-right-title-body ul li").each(function () {
    ...
    "titleDisplay":function (text) {
        $("#home-right-title-body ul").append("<li><span>"+text+"</span><a  href=\"javascript:void(0);\">X</a></li>");
    },
    ...
    "apiDocRequest":function () {
        $.ajax({url:menu_manager.url.apiDocUrl,success:function(result){
                $("#home-right-body-sys-apidoc").html(result);
            }});
    },
 ...
 */
$(function () {
    $("#home-menu-auth-nva").find("a").on("click",function (e) {
 ...
 */
$(function () {
   $("#home-right-title-body ul").on("click","li",function (e) {
       console.log("删除标题.....");
       console.log($(this));
       $(this).remove();
   })
 ...
 */
$(function () {
    $("#home-menu-sys-nva").find("a").on("click",function (e) {
        $(".menu_nva_select").removeClass("menu_nva_select");
        $(this).toggleClass("menu_nva_select");
        console.log("当前菜单名称 = "  + menu_manager.getMenuStr($(this).text()));
        menu_manager.handlerMenuClick(menu_manager.getMenuStr($(this).text()))
 ...
 */
$(function () {
    $("#home-menu-task-nva").find("a").on("click",function (e) {
        $(".menu_nva_select").removeClass("menu_nva_select");
        $(this).toggleClass("menu_nva_select");
        console.log("当前菜单名称 = "  + menu_manager.getMenuStr($(this).text()));
        menu_manager.handlerMenuClick(menu_manager.getMenuStr($(this).text()))
